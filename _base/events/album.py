...
class Album(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        Members:
            messages (Sequence[`Message <spluspy.tl.custom.message.Message>`]):
        ...
        async def get_reply_message(self):
            """
            The `Message <spluspy.tl.custom.message.Message>`
        ...
        async def reply(self, *args, **kwargs):
            ...
            for `spluspy.client.messages.MessageMethods.send_message`
