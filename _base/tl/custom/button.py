...
class Button:
    ...
    .. note::
        ...
        `Message.buttons <spluspy.tl.custom.message.Message.buttons>`
    ...
    def inline(text, data=None):
        ...
        <spluspy.events.callbackquery.CallbackQuery>` will trigger with the
        ...
        Args:
            bot (`hints.EntityLike`):
                ...
                .. note::
                    ...
                    <spluspy.client.users.UserMethods.get_input_entity>`.
    ...
    def text(cls, text, *, resize=None, single_use=None, selective=None,
        ...
        <spluspy.events.newmessage.NewMessage>`. You cannot distinguish
