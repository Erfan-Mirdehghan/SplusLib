...
class MessageMethods:
    ...
    def iter_messages(
        ...
        Arguments
            ...
            reply_to (`int`, optional):
                ...
                will result in ``spluspy.errors.PeerIdInvalidError`` to occur.
        ...
        Yields
            Instances of `Message <spluspy.tl.custom.message.Message>`.
        ...
        Example
            .. code-block:: python
                ...
                from spluspy.tl.types import InputMessagesFilterPhotos
    ...
    async def get_messages(
        ...
        `TotalList <spluspy.helpers.TotalList>` instead.
        ...
        a single `Message <spluspy.tl.custom.message.Message>` will be
    ...
    async def send_message(
        ...
        See also `Message.respond() <spluspy.tl.custom.message.Message.respond>`
        and `Message.reply() <spluspy.tl.custom.message.Message.reply>`.

        Arguments
            entity (`entity`):
                To who will it be sent.

            message (`str` | `Message <spluspy.tl.custom.message.Message>`):
            ...
            reply_to (`int` | `Message <spluspy.tl.custom.message.Message>`, optional):
        ...
        Returns
            The sent `custom.Message <spluspy.tl.custom.message.Message>`.
        ...
        Example
            .. code-block:: python
                ...
                from spluspy import events, Button
    ...
    async def forward_messages(
        ...
        See also `Message.forward_to() <spluspy.tl.custom.message.Message.forward_to>`.

        Arguments
            entity (`entity`):
                To which entity the message(s) will be forwarded.

            messages (`list` | `int` | `Message <spluspy.tl.custom.message.Message>`):
        ...
        Returns
            The list of forwarded `Message <spluspy.tl.custom.message.Message>`,
    ...
    async def edit_message(
        ...
        See also `Message.edit() <spluspy.tl.custom.message.Message.edit>`.

        Arguments
            entity (`entity` | `Message <spluspy.tl.custom.message.Message>`):
            ...
            message (`int` | `Message <spluspy.tl.custom.message.Message>` | :tl:`InputMessageID` | `str`):
                The ID of the message (or `Message
                <spluspy.tl.custom.message.Message>` itself) to be edited.
                If the `entity` was a `Message
                <spluspy.tl.custom.message.Message>`, then this message
                will be treated as the new text.

            text (`str`, optional):
                The new text of the message. Does nothing if the `entity`
                was a `Message <spluspy.tl.custom.message.Message>`.
        ...
        Returns
            The edited `Message <spluspy.tl.custom.message.Message>`,
    ...
    async def delete_messages(
        ...
        See also `Message.delete() <spluspy.tl.custom.message.Message.delete>`.
        ...
        Arguments
            ...
            message_ids (`list` | `int` | `Message <spluspy.tl.custom.message.Message>`):
    ...
    async def send_read_acknowledge(
        ...
        See also `Message.mark_read() <spluspy.tl.custom.message.Message.mark_read>`.

        Arguments
            entity (`entity`):
                The chat where these messages are located.

            message (`list` | `Message <spluspy.tl.custom.message.Message>`):
    ...
    async def pin_message(
        ...
        See also `Message.pin() <spluspy.tl.custom.message.Message.pin>`.

        Arguments
            entity (`entity`):
                The chat where the message should be pinned.

            message (`int` | `Message <spluspy.tl.custom.message.Message>`):
    ...
    async def unpin_message(
        ...
        See also `Message.unpin() <spluspy.tl.custom.message.Message.unpin>`.
