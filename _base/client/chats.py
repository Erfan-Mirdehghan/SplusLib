...
class ChatMethods:
    ...
    def iter_participants(
        ...
        Example
            .. code-block:: python
                ...
                # Filter by admins
                from spluspy.tl.types import ChannelParticipantsAdmins
    ...
    def iter_admin_log(
        ...
        *all* event types will be returned. If at least one of them is
        ...
        Yields
            Instances of `AdminLogEvent <spluspy.tl.custom.adminlogevent.AdminLogEvent>`.
    ...
    async def kick_participant(
        ...
        Returns
            Returns the service `Message <spluspy.tl.custom.message.Message>`
    ...
    async def get_permissions(
        ...
        Returns
            A `ParticipantPermissions <spluspy.tl.custom.participantpermissions.ParticipantPermissions>`
    ...
    async def get_stats(
        ...
        Raises
            ...
            ``spluspy.errors.ChatAdminRequiredError`` will appear.
