...
class MessageButton:
    ...
    .. note::
        ...
        <spluspy.tl.custom.button.Button>` instead.
    ...
    def client(self):
        """
        Returns the `spluspy.client.soroushclient.SoroushClient`
    ...
    async def click(self, share_phone=None, share_geo=None, *, password=None, open_url=None):
        ...
        sent, and the sent `Message <spluspy.tl.custom.message.Message>` returned.
