...
class Message(ChatGetter, SenderGetter, TLObject):
    ...
    <spluspy.tl.custom.chatgetter.ChatGetter>` and `SenderGetter
    <spluspy.tl.custom.sendergetter.SenderGetter>` which means you
    ...
    Members:
        ...
        message (`str`):
            ...
            <spluspy.tl.custom.message.Message>` instances,
    ...
    def client(self):
        """
        Returns the `SoroushClient <spluspy.client.soroushclient.SoroushClient>`
    ...
    def forward(self):
        """
        The `Forward <spluspy.tl.custom.forward.Forward>`
    ...
    def buttons(self):
        ...
        <spluspy.tl.custom.messagebutton.MessageButton>`,
        if any.
    ...
    def file(self):
        """
        Returns a `File <spluspy.tl.custom.file.File>` wrapping the
        ...
        `file.id <spluspy.tl.custom.file.File.id>`,
        `file.name <spluspy.tl.custom.file.File.name>`,
    ...
    def get_entities_text(self, cls=None):
        ...
        Args:
            cls (`type`):
                ...
                >>> from spluspy.tl.types import MessageEntityCode
                >>>
                >>> m = ...  # get the message
    ...
    async def respond(self, *args, **kwargs):
        ...
        `spluspy.client.messages.MessageMethods.send_message`
    ...
    async def forward_to(self, *args, **kwargs):
        ...
        `spluspy.client.messages.MessageMethods.forward_messages`
        ...
        `spluspy.client.soroushclient.SoroushClient` instance directly.
        """
        if self._client:
    ...
    async def edit(self, *args, **kwargs):
        ...
        `spluspy.client.messages.MessageMethods.edit_message`
    ...
    async def delete(self, *args, **kwargs):
        ...
        Shorthand for
        `spluspy.client.messages.MessageMethods.delete_messages` with
    ...
    async def download_media(self, *args, **kwargs):
        ...
        for `spluspy.client.downloads.DownloadMethods.download_media`
    ...
    async def click(self, i=None, j=None,
        ...
        or `button.click <spluspy.tl.custom.messagebutton.MessageButton.click>`
        ...
        Args:
            ...
            filter (`callable`):
                ...
                `MessageButton <spluspy.tl.custom.messagebutton.MessageButton>`
                or `PollAnswer <spluspy.tl.types.PollAnswer>` argument.
    ...
    async def mark_read(self):
        ...
        <spluspy.client.messages.MessageMethods.send_read_acknowledge>`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
    ...
    async def pin(self, *, notify=False, pm_oneside=False):
        ...
        `spluspy.client.messages.MessageMethods.pin_message`
        with both ``entity`` and ``message`` already set.
        """
    ...
    async def unpin(self):
        ...
        `spluspy.client.messages.MessageMethods.unpin_message`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
