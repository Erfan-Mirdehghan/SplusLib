...
class InlineBuilder:
    ...
    <spluspy.events.inlinequery.InlineQuery>` ``results``.
    ...
    explained here to avoid repetition:
        ...
        buttons (`list`, `custom.Button <spluspy.tl.custom.button.Button>`, :tl:`KeyboardButton`, optional):
    ...
    async def photo(
        ...
        Args:
            ...
            file (`obj`, optional):
                ...
                <spluspy.client.uploads.UploadMethods.send_file>`.
