...
class AccountMethods:
    def takeout(
        ...
        """
        Returns a :ref:`spluspy-client` which calls methods behind a takeout session.
        ...
        <spluspy.client.messages.MessageMethods.iter_messages>`.
        ...
        <spluspy.sessions.abstract.Session.takeout_id>`.
