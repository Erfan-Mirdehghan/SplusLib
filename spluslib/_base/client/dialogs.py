        ...
        for d in r.dialogs:
            ...
            if peer_id not in self.seen:
                ...
                if peer_id not in entities:
                    ...
                    # Real world example: https://splus.ir/SPlusthonChat/271471
                    continue
...
class DialogMethods:
    ...
    def iter_dialogs(
        ...
        Yields
            Instances of `Dialog <spluspy.tl.custom.dialog.Dialog>`.
    ...
    def iter_drafts(
        ...
        Yields
            Instances of `Draft <spluspy.tl.custom.draft.Draft>`.
    ...
    async def delete_dialog(
        ...
        See also `Dialog.delete() <spluspy.tl.custom.dialog.Dialog.delete>`.
    ...
    def conversation(
        ...
        """
        Creates a `Conversation <spluspy.tl.custom.conversation.Conversation>`
        ...
        Arguments
            ...
            replies_are_responses (`bool`, optional):
                ...
                <spluspy.tl.custom.conversation.Conversation.get_response>`
                and a subsequent call to `conv.get_reply
                <spluspy.tl.custom.conversation.Conversation.get_reply>`
        ...
        Returns
            A `Conversation <spluspy.tl.custom.conversation.Conversation>`.
