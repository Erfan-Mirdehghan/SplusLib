...
class MessageEdited(NewMessage):
    ...
    <spluspy.events.newmessage.NewMessage>`, you should treat
    this event as a `Message <spluspy.tl.custom.message.Message>`.

    .. warning::

        On channels, `Message.out <spluspy.tl.custom.message.Message>`
