...
class CallbackQuery(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        async def respond(self, *args, **kwargs):
            ...
            `spluspy.client.messages.MessageMethods.send_message` with
            ``entity`` already set.
        ...
        async def edit(self, *args, **kwargs):
            ...
            `spluspy.client.messages.MessageMethods.edit_message` with
            ...
            .. note::
                ...
                `Message.edit <spluspy.tl.custom.message.Message.edit>`,
